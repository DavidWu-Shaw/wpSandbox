...
Upgrade to [Simmer Pro](https://simmerwp.com/#membership) for complete nutrition content for Google Structured Data output, in addition to complete aggregate star rating support and training and documentation resources for customers only. 

Every WordPress theme handles recipes and custom post types differently. For customized support for your theme's code, [purchase a Simmer Pro license](https://simmerwp.com/#membership) for premium support from Simmer [customer service](https://simmerwp.com/contact) and other benefits.
